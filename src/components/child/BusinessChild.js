...
const BusinessChild = () => {
  ...
  useEffect(() => {
    truncateText("trun-bs-c", 150);
    truncateText("trun-sm-head", 70);
  }, [category]);
  return (
    <div>
      <Navbar />
      ...
      {category === "Econ" && (
        <>
          <h1 className="title-style-head">Finance and economy</h1>
        </>
      )}
      {category === "Tech" && (
        <>
          <h1 className="title-style-head">Technology of Business</h1>
        </>
      )}
      ...
      <div className="container-xxl container-style">
        {category === "Econ" && (
          <>
                ...
                <div className="row">
                  <div className="col-md-6 ">
                    <Link
                      ...
                      className="linkto"
                      to={`/viewpage/Business/${category}/1`}>
                      <img
                  ...
                  <div className="col-md-6 " style={{}}>
                    ...
                    <Link
                      ...
                      to={`/viewpage/Business/${category}/1`}>
                      <p
                        className="card-text  trun-bs-c text-gray"
                        style={{
                          width: "95%",
                          textAlign: "justify",
                          fontSize: "15px",
                        }}>
                        {Business.Econ[0].content[0]}{" "}
                        {Business.Econ[0].content[1]}
                      </p>
                    </Link>
                  </div>
                </div>
                    ...
                    <div className="row">
                      <div className="card-img-top">
                        <Link
                          onClick={handleLinkClick}
                          className="linkto"
                          to={`/viewpage/Business/${category}/${item.id}`}>
                          <img
                            src={item.images[0]}
                            style={{
                              height: "",
                      ...
                      <div className="card-body">
                        <Link
                          ...
                          to={`/viewpage/Business/${category}/${item.id}`}>
                          <b
                            className="card-title trun-sm-head text-hover"
                            style={{ fontSize: "16px" }}>
                            {item.title}
                          </b>
                        </Link>
            ...
            {Business.Econ.slice(itemStartID - 1 + itemsPerPage).map((item) => (
                  ...
                  <div className="col-lg-8 col-md-7 col-sm-6 col-7 ">
                    <div className="card-body">
                      <Link
                        ...
                        className="linkto"
                        to={`/viewpage/Business/${category}/${item.id}`}>
                        <b className="card-title trun-sm-head text-hover card-title-style">
                          {item.title}
                        </b>
                      </Link>
                      <Link
                        ...
                        className="linkto"
                        to={`/viewpage/Business/${category}/${item.id}`}>
                        <p className="card-text trun-bs-c text-gray card-text-style">
        ...
        {category === "Tech" && (
          <>
                  ...
                  <div className="col-md-6 " style={{}}>
                    ...
                    <Link
                      ...
                      <p
                        ...
                        {Business.Tech[0].content[0]}{" "}
                        {Business.Tech[0].content[1]}
                      </p>
                    </Link>
                  </div>
                </div>
            ...
            {Business.Tech.slice(itemStartID - 1 + itemsPerPage).map((item) => (
